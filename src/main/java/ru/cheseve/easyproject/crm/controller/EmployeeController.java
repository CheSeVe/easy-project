...
import ru.cheseve.easyproject.crm.enums.EmployeeSort;
import ru.cheseve.easyproject.crm.service.EmployeeService;
...
public class EmployeeController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<EmployeeResponse> putEmployee(@PathVariable Long id,
                                                        @RequestBody @Valid EmployeeRequest requestDTO) {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<EmployeeResponse> patchEmployee(@PathVariable Long id,
                                                          @RequestBody @Valid EmployeePatchRequest requestDTO) {
